                    ...
                    <form action="Category?action=<%=action%>" method="post">
                        <div class="form-row profile-row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group"><label style="color: rgb(31,40,81);font-size: 16px;font-weight: bold;">Category</label><input name="category" class="form-control" type="text" style="border-color: rgb(31,40,81);"></div>
